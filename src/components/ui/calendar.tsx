...
function CalendarDayButton({
  ...
  return (
    <Button
      ...
      className={cn(
        "flex aspect-square size-auto w-full min-w-(--cell-size) flex-col gap-1 font-normal leading-none group-data-[focused=true]/day:relative group-data-[focused=true]/day:z-10 group-data-[focused=true]/day:border-ring group-data-[focused=true]/day:ring-[3px] group-data-[focused=true]/day:ring-ring/50 data-[range-end=true]:rounded-md data-[range-end=true]:rounded-r-md data-[range-end=true]:bg-brand data-[range-end=true]:text-white data-[range-middle=true]:rounded-none data-[range-middle=true]:bg-brand/10 data-[range-middle=true]:text-[#222] data-[range-start=true]:rounded-md data-[range-start=true]:rounded-l-md data-[range-start=true]:bg-brand data-[range-start=true]:text-white data-[selected-single=true]:bg-brand data-[selected-single=true]:text-white hover:data-[selected-single=true]:bg-brand-hover dark:hover:text-accent-foreground [&>span]:text-xs [&>span]:opacity-70",
  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        caption_label: cn(
          "select-none font-semibold capitalize text-[#222]",
          captionLayout === "label"
            ? "text-sm"
