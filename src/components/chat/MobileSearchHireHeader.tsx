...
export function MobileSearchHireHeader({
  ...
  return (
    <header className="lg:hidden flex shrink-0 items-center gap-2 border-b border-line bg-white px-3 py-2.5 z-40">
      <Button
        variant="ghost"
        size="icon"
        onClick={onBack}
      ...
      <div className="min-w-0 flex-1">
        <h1 className="truncate text-lead font-semibold tracking-[-0.01em] text-ink-strong leading-tight">
          {title}
        </h1>
