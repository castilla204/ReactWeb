...
export default function FormacionEditor({ value, onChange, hideHeader = false }: FormacionEditorProps) {
    ...
    return (
        <div className="pf-formacion">
            ...
            <p style={{ fontSize: 12, color: 'hsl(var(--ink-muted))', margin: '0 0 10px' }}>
            ...
            {items.length === 0 && (
                <p style={{ fontSize: 13, color: 'hsl(var(--ink-soft))', margin: '0 0 8px' }}>
                    ...
                    >
                        <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                            ...
                            <button
                                ...
                                style={{ border: 'none', background: 'transparent', color: 'hsl(var(--ink-soft))', cursor: 'pointer', padding: 4 }}
                            >
                                <Trash2 size={18} />
                            </button>
                        </div>
                        ...
                        <label style={{ display: 'flex', alignItems: 'center', gap: 8, fontSize: 13, cursor: 'pointer' }}>
                            ...
                            />
                            <BadgeCheck size={16} style={{ color: it.esOficial ? 'hsl(var(--success))' : 'hsl(var(--ink-soft))' }} />
                            ...
                            {it.imagen ? (
                                <div style={{ position: 'relative' }}>
                                    <img
                                        src={it.imagen}
                                        alt="Título / centro"
                                        style={{ width: 72, height: 72, objectFit: 'cover', borderRadius: 8, border: '0.5px solid hsl(var(--line))' }}
                                    />
                                    <button
                                        type="button"
                                        ...
                                        style={{
                                            ...
                                            color: 'hsl(var(--surface))', border: 'none', borderRadius: '50%', width: 22, height: 22,
                                ...
                                <label
                                    style={{
                                        ...
                                        border: '0.5px dashed hsl(var(--line))', borderRadius: 8, padding: '8px 12px',
                                        color: 'hsl(var(--ink-muted))', cursor: 'pointer', background: 'hsl(var(--surface))',
                                    }}
                                >
            ...
            <button
                ...
                style={{
                    ...
                    border: '0.5px solid hsl(var(--line))', borderRadius: 10, padding: '8px 12px',
                    background: 'hsl(var(--surface))', fontSize: 13, cursor: 'pointer',
                }}
            >
