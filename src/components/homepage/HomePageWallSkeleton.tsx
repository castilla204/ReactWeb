...
export const HomePageWallSkeleton: React.FC = () => (
  <div className="w-full max-w-[1280px] mx-auto px-4 md:px-6 lg:px-10 pt-4 md:pt-8 pb-6">
    ...
    <div className="flex gap-4 overflow-hidden pb-3">
      {[1, 2, 3, 4, 5].map((i) => (
        <div key={i} className="shrink-0 w-[160px] md:w-[184px]">
          <div className="aspect-square md:aspect-[4/3] w-full rounded-[20px] md:rounded-xl bg-[#f0f0f0] animate-pulse mb-2" />
