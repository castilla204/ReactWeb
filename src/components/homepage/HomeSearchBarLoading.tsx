  ...
  <>
    ...
    >
      <div className={HP_MOBILE_HEADER_INSET_CLASS}>
        <div
          className="relative flex w-full items-center gap-3 rounded-full border border-brand/25 bg-white px-4"
          style={{
            height: HP_LOADING_DIMS.searchPillH,
            boxShadow: HP_LOADING_DIMS.searchPillShadow,
          }}
        >
          <MapPin className="h-5 w-5 shrink-0 text-brand" strokeWidth={2} aria-hidden />
          <div className="min-w-0 flex-1 space-y-1">
            <div className="h-3.5 w-44 rounded bg-line-soft" />
            <div className="h-3 w-36 rounded bg-surface-tinted" />
          </div>
