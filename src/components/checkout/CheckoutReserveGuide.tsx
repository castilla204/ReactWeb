...
export const CheckoutReserveHint: React.FC<{ className?: string }> = ({ className = '' }) => (
  <div
    className={`space-y-2 text-[11px] leading-[15px] text-[#6a6a6a] ${className}`.trim()}
  ...
  >
    <p>
      ...
      pasas a un pago seguro con Stripe. El importe queda en custodia y no se libera al experto hasta
      que apruebes el informe.
    </p>
    <p>
